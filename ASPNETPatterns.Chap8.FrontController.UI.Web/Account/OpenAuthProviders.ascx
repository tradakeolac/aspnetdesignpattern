<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="ASPNETPatterns.Chap8.FrontController.UI.Web.Account.OpenAuthProviders" %>
