...
namespace Agathas.Storefront.Services.Implementations
{
    public class ProductCatalogService : IProductCatalogService
    {
        ...
        Query productQuery)
        {
            IEnumerable<Product> productsMatchingRefinement =
            _productRepository.FindBy(productQuery);
        ...
        public GetFeaturedProductsResponse GetFeaturedProducts()
        {
            ...
            new GetFeaturedProductsResponse();
        ...
        GetProductsByCategoryRequest request)
        {
            ...
            Query productQuery =
            ProductSearchRequestQueryGenerator.CreateQueryFor(request);
            IEnumerable<Product> productsMatchingRefinement =
            GetAllProductsMatchingQueryAndSort(request, productQuery);
            response = productsMatchingRefinement
        ...
        public GetProductResponse GetProduct(GetProductRequest request)
        {
            ...
            _productTitleRepository.FindBy(request.ProductId);
